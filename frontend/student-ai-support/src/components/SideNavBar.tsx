...
export const SideNavBar: React.FC<SideNavBarProps> = ({ onOpenSupportTicket }) => {
  ...
  return (
    <aside className="w-[260px] h-screen sticky left-0 top-0 bg-[#eff4ff] border-r border-[#c2c7d1] flex flex-col p-4 space-y-2 shrink-0 z-50 select-none">
      {/* Brand Identity */}
      <div className="flex items-center gap-3 px-2 py-3 cursor-pointer" onClick={() => navigate('/dashboard')}>
        <div className="w-10 h-10 bg-[#00355f] rounded-lg flex items-center justify-center text-white shadow-sm">
          <span className="material-symbols-outlined text-[24px]">school</span>
        </div>
        <div>
          <h1 className="font-headline text-[18px] font-bold text-[#00355f] leading-tight">Hypervisor</h1>
          <p className="text-[10px] text-[#42474f] uppercase tracking-wider font-semibold">Educational Complex</p>
        </div>
      </div>
